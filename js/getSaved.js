    ...
    teams.forEach(data => {
        ...
        <a href="./team.html?id=${data.id}&saved=true">
            ...
            <div class="col s12 center-align">
                <img src="${data.crestUrl.replace(/^http:\/\//i, 'https://')}" alt="${data.name}" class="responsive-img" style="padding: 30px 0 10px 0; height: 100%; width: 200px;"/>
            </div>
...
const showSavedTeamById = team => {
    ...
    club += `
        ...
        <img class="responsive-img" alt="${team.name}" src="${team.crestUrl.replace(/^http:\/\//i, 'https://')}" style="height:100%;"/>
        </div>
